...
export const loggedInTaglines: LoggedInTagline[] = [
  ...
  { text: "유연한 남탓, 사고하지 않기" },
  { text: "오늘 할 일은 Opus가, 내일 할 일은 다음 버전이" },
  { text: "Sonnet은 썸녀, Opus는 여자친구" },
  { text: "테스트 코드를 굳이 짜야 할까요?", reply: "물론 저는 기도 메타로 배포합니다" },
  { text: "오늘 업무: Gemini에게 화내기 / 내일 업무: ChatGPT에게 사과하기" },
  ...
  // F. 여러 AI를 동시에 굴리는 시대 (2026-09 추가 — 한 브랜드 편중 해소)
  { text: "AI 세 개 열어놓고 제일 마음에 드는 답만 고르는 중" },
  { text: "Cursor로 짜고 Copilot이 자동완성하고 Gemini가 리뷰함" },
  { text: "모델 이름이 매달 바뀌어서 이제 안 외움" },
  { text: "무료 한도 다 쓰고 다른 AI로 갈아타 본 적 있음" },
  { text: "AI가 \"이제 완벽합니다\"라고 했는데 여전히 안 됨" },
  { text: "v0로 화면 뽑고 Cursor로 고치고 Vercel에 올림" },
  { text: "이번 달 AI 구독료가 통신비를 넘음" },
  { text: "흠.. AI를 하나만 써야 할까요?", reply: "물론 저는 네 개 동시에 씁니다" },
  { text: "ChatGPT한테 묻고 Claude한테 검증받고 Gemini한테 한 번 더" },
  { text: "Copilot이 짠 코드를 Copilot이 리뷰하는 완전체" },
  { text: "영역전개 — AI 채팅창 여덟 개 동시에 열기" },
  { text: "Lovable로 시작해서 Cursor로 끝낸 주말" },
  { text: "AI가 올린 PR을 AI가 리뷰하고 머지는 사람이" },
...
export const loggedInTaglinesEn: LoggedInTagline[] = [
  ...
  { text: "Let Opus handle today. Whatever ships next handles tomorrow" },
  ...
  { text: "Today: yelling at Gemini / Tomorrow: apologizing to ChatGPT" },
  ...
  // F. 여러 AI를 동시에 굴리는 시대 (2026-09 추가 — 한 브랜드 편중 해소)
  { text: "Three AI tabs open, cherry-picking the best answer" },
  { text: "Written in Cursor, autocompleted by Copilot, reviewed by Gemini" },
  { text: "Model names change monthly — stopped memorizing them" },
  { text: "Has burned a free tier and switched to another AI mid-project" },
  { text: "The AI said \"it's perfect now\" and it still doesn't work" },
  { text: "Screens from v0, fixes from Cursor, shipped on Vercel" },
  { text: "This month's AI subscriptions cost more than the phone bill" },
  { text: "Do I really need more than one AI?", reply: "I keep four open, obviously" },
  { text: "Ask ChatGPT, verify with Claude, double-check with Gemini" },
  { text: "Copilot writes it, Copilot reviews it, balance restored" },
  { text: "Domain Expansion — eight AI chat tabs at once" },
  { text: "Started in Lovable, finished in Cursor, all in one weekend" },
  { text: "AI opens the PR, AI reviews it, a human clicks merge" },
