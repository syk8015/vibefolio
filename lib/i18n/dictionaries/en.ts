...
export const en: Dictionary = {
  ...
  connect: {
    ...
    copiedNote: "Pressing this button again auto-revokes the previous token.",
    copiedButton: "Copied ✓",
    ...
    pasteJsonLead: "Did your AI just hand you JSON and stop?",
    ...
    mcpToggle: "Connect over MCP — no pasting at all",
    mcpLead: "Attach Nookframe as an MCP server in Claude Code, Claude Desktop or Cursor and \"publish this to Nookframe\" is the whole job. No prompt to paste, no JSON to carry over.",
    mcpRemoteTitle: "Claude web & desktop app — just paste the URL",
    mcpRemoteHint: "In Claude: Settings → Connectors → Add custom connector, paste this URL, then follow the prompt and press Allow. Nothing to install, no token to move.",
    ...
    mcpCopy: "Copy with token filled in",
    mcpCopying: "Issuing token…",
    mcpCopied: "Copied — the token is already filled in, paste it as-is. Copying again revokes the previous MCP token.",
