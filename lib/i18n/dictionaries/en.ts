...
export const en: Dictionary = {
  ...
  signup: {
    ...
    handoffSubtitle: "Picking up from your phone — get a code by email to continue.",
  ...
  projects: {
    ...
    connectSubtitle: "It arrives as a draft. Nothing goes public until you review it.",
  ...
  card: {
    ...
    basicTitle: "Basics",
    basicBody: "The name and address printed big on your card.",
    aboutTitle: "Bio & links",
    aboutBody: "Shown at the bottom of your card as a one-line bio and link icons.",
    avatarLabel: "Photo",
    changeImage: "Change photo",
    uploadImage: "Upload photo",
    photoHelp: "Used on your mobile card and share cards. JPG, PNG or GIF, up to 5MB.",
  ...
  loginMethods: {
    ...
    intro: "Any method linked here signs you in to this same account.",
    email: "Email",
    ...
    contact: "Email us",
    failed: "Linking was cancelled or didn't finish. Please try again.",
    startFailed: "Couldn't start linking. Please try again in a moment.",
    unlinkFailed: "Couldn't unlink. Please try again in a moment.",
  },
  settings: {
    title: "Settings",
    back: "Dashboard",
    ...
    light: "Light",
    dark: "Dark",
    sessionsLabel: "Sign-in sessions",
    logoutHere: "Log out on this device",
    logoutHereBody: "Only the device you're using now.",
    ...
    aiLabel: "AI connections",
    aiTitle: "Connected AI tools",
    aiBody: (n: number) => `See and disconnect the ${n} connection${n === 1 ? "" : "s"} you gave tools like Claude Code or Cursor.`,
    aiEmpty: "No AI tools connected yet.",
    aiLoadFailed: "Couldn't load your connections.",
    aiManage: "Manage",
    aiClose: "Hide",
    oauthTokenName: (host: string) => `${host} connector`,
  ...
  connect: {
    ...
    whichToggle: "Not sure which one?",
    changeTool: "Change",
    stepsTerminal: (tool: string | null) => ["Press Copy prompt.", tool ? `Paste it into ${tool} as is.` : "Paste it into the AI that built your work."],
    chatStep1: "Copy the prompt and paste it into the chat where you built the work.",
    chatStep2: "Copy the AI's whole reply, then press this.",
    stepsClaude: [
      "Copy the URL.",
      "In Claude: Settings → Connectors → Add custom connector, and paste it.",
      "In the chat where you built the work, say \"publish this to Nookframe\".",
    ],
    claudeOnceTag: "first time only",
    claudeHelpToggle: "Not working?",
    claudeAllowHint: "If it asks how to connect, keep the recommended option.",
    ...
    previewToggle: "See the prompt",
    moreToggle: "See the prompt · Connect with MCP",
  ...
  handoff: {
    pageTitle: "Send to your computer | Nookframe",
    title: "Continue on your computer",
    body: "Nookframe works through the AI tool on your computer. Enter your email and we'll send a link you can open there.",
    emailLabel: "Email",
    remindLabel: "Remind me tomorrow (optional)",
    submit: "Email me the link",
    sending: "Sending…",
    sentTitle: "Sent!",
    sentBody: "Open the email on your computer and tap the button. Not there? Check your spam folder.",
    sendAgain: "Use a different email",
    signupHere: "Sign up here instead →",
    privacyNote: "We send one email with your link — plus one reminder tomorrow if you ask. Your address is deleted after 30 days.",
    accountTitle: "You're in! Now continue on your computer",
    accountBody: "Projects go up through the AI tool on your computer. Tap the button and we'll email a link to this address that you can open there.",
    browseFirst: "Look around on my phone first →",
  },
  publish: {
    ...
    typeToggle: "I'll paste it myself",
  ...
  api: {
    ...
    handoffBadEmail: "Please check your email address.",
    handoffCaptcha: "Please complete the security check again.",
    handoffRateLimited: "Too many requests. Please try again later.",
    handoffSendFailed: "We couldn't send the email. Please try again in a moment.",
  ...
  email: {
    ...
    handoffSubject: "Your Nookframe link — from your phone",
    handoffPreheader: "Open this on your computer and tap the button.",
    handoffHeading: "Pick up where you left off",
    handoffBody: "Nookframe works through the AI tool on your computer (Claude Code, Cursor, ChatGPT and the like). The button below opens Nookframe with your email filled in — get a code by email and you are about three minutes from your first project.",
    handoffCta: "Open Nookframe",
    handoffTypeHint: "If the button doesn't work, just type nookframe.com into your browser.",
    handoffNotYou: "Didn't ask for this? Ignore this email — we won't send another.",
    handoffRemindSubject: "Your Nookframe link from yesterday",
    handoffRemindPreheader: "At your computer? You can pick it up now.",
    handoffRemindHeading: "At your computer?",
    handoffRemindBody: "You asked for a reminder from your phone yesterday, so here it is. The button opens Nookframe with your email filled in; paste one line into your AI and your first project is up.",
    handoffRemindLast: "This is the only reminder we'll send.",
  },
};
