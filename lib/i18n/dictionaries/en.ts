...
export const en: Dictionary = {
  ...
  connect: {
    ...
    pickTerminal: "Claude Code · Cursor",
    pickTerminalSub: "An AI in your terminal or code editor",
    pickClaude: "Claude",
    pickClaudeSub: "claude.ai on the web · desktop app",
    pickChat: "ChatGPT · Gemini",
    pickChatSub: "Any other chat AI",
    stepsTerminal: "Copy the prompt → paste it into that AI → a draft lands here → review & publish",
    stepsChat: "Copy the prompt → paste it into the chat where you built it → bring the AI's reply back here → review & publish",
    stepsClaude: "Copy the URL → paste it once into Claude's settings → say \"publish this to Nookframe\" in the chat where you built it",
    ...
    chatNextTitle: "When the AI replies, bring the reply here",
    chatNextBody: "A chat AI can't upload on its own. Copy its whole reply, then press the button below. It opens in a new tab, and this window keeps waiting — the review screen opens the moment the work arrives.",
    pasteJsonLead: "Did your AI just reply and stop?",
    pasteJsonCta: "Paste the AI's reply",
    pasteJsonHint: "That AI couldn't upload by itself. Copy its whole reply, press this, and paste — that's the whole job. Files go on the same screen.",
    ...
    mcpRemoteTitle: "Paste this URL into Claude's settings, once",
    mcpRemoteHint: "In Claude: Settings → Connectors → Add custom connector, paste this URL, then follow the prompt and press Allow. Nothing to install, no key to move.",
    mcpRemoteAuthTip: "If it asks how to connect, keep the option marked as recommended.",
    mcpRemoteNext: "From then on, just say \"publish this to Nookframe\" in the chat where you built it. When the draft lands, this window opens the review screen by itself.",
