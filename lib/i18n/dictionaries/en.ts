...
export const en: Dictionary = {
  ...
  connect: {
    ...
    stepsChat: ["Press Copy prompt.", "Paste it into the chat where you built the work.", "Copy the AI's whole reply and bring it back with Paste the AI's reply.", "Review it and publish."],
    stepsClaude: [
      "Copy the URL below.",
