...
export const en: Dictionary = {
  ...
  projects: {
    ...
    publishedNoticePaused: "Published · recording request received — takes are shot in order, we'll email you when it's done",
    ...
    progressPausedBody: "Takes are currently shot in batches, in order. Yours starts automatically when its turn comes, and we'll email you when it's done.",
