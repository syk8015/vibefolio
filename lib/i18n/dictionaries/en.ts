...
export const en: Dictionary = {
  ...
  email: {
    ...
    handoffBody: "Nookframe works through the AI tool on your computer (Claude Code, Cursor, ChatGPT and the like). The button below opens sign-up with your email already filled in — about three minutes to your first project.",
    ...
    handoffRemindBody: "You asked for a reminder from your phone yesterday, so here it is. The button opens sign-up; paste one line into your AI and your first project is up.",
