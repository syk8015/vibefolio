...
export const ko = {
  ...
  connect: {
    ...
    stepsChat: ["[프롬프트 복사]를 눌러요.", "작품을 만든 대화에 붙여넣어요.", "AI 답을 통째로 복사해서 아래 칸에 붙여넣어요.", "확인하고 공개하면 끝이에요."],
    ...
    chatNextTitle: "AI 답을 받으면 여기에 붙여넣어요",
    // D6(2026-09-22): 새 탭 /publish 대신 이 창 안에서 바로 올린다 — 폰에서 새 브라우저가 열려 다시 로그인하던 단계가 사라진다.
    chatNextBody: "올라간 작품은 나만 보이는 초안이에요. 공개는 확인 화면에서 내가 눌러야 돼요.",
    // 터미널 AI가 예상과 달리 답만 주고 끝난 경우의 출구(2026-09-18).
    pasteJsonLead: "AI가 답만 주고 끝났나요?",
    pasteJsonCta: "여기에 붙여넣기",
    pasteJsonHint: "그 AI가 스스로 못 올리는 경우예요. AI 답을 통째로 복사해서 아래 칸에 붙여넣으면 돼요.",
