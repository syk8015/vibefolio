...
export const ko = {
  ...
  projects: {
    ...
    connectSubtitle: "작품을 만든 AI가 여기에 초안으로 올려줘요. 공개는 내가 확인한 뒤에만 돼요.",
    editTitle: "프로젝트 수정",
    submitSave: "저장하기",
  ...
  connect: {
    ...
    stepsTerminal: ["[프롬프트 복사]를 눌러요.", "작품을 만든 AI에게 그대로 붙여넣어요.", "AI가 올리면 초안이 여기 도착해요. 확인하고 공개하면 끝이에요."],
    stepsChat: ["[프롬프트 복사]를 눌러요.", "작품을 만든 대화에 붙여넣어요.", "AI 답을 통째로 복사해서 [AI 답 붙여넣기]로 가져와요.", "확인하고 공개하면 끝이에요."],
    // Claude 연결 단계는 Claude 앱 자체의 화면이라 줄일 수 없다 — 대신 딱 한 번이다.
    stepsClaude: [
      "아래 주소를 복사해요.",
      "Claude에서 설정 → 커넥터 → [커스텀 커넥터 추가]에 붙여넣고 [허용]을 눌러요. 연결 방식을 물으면 추천된 쪽을 그대로 두세요.",
      "작품을 만든 대화에서 \"이거 Nookframe에 올려줘\"라고 말해요. 초안이 오면 이 창이 확인 화면을 열어요.",
    ],
    claudeOnce: "이 연결은 처음 한 번만 하면 돼요.",
    copyPrompt: "프롬프트 복사",
    copying: "준비 중…",
    // 프롬프트에 든 건 토큰이 아니라 30분·1회용 연결 코드다(2026-09-16). 다시 눌러도
    // 옛 코드가 폐기되지는 않는다 — 새 코드가 들어갈 뿐.
    copiedNote: "이 프롬프트 속 연결 코드는 30분 동안 한 번만 쓸 수 있어요. 다시 누르면 새 코드가 들어가요.",
    // 복사 성공을 버튼 자체가 말하게 한다(2026-09-05) — 아래 작은 문구만으로는
    // 눌렸는지 티가 안 난다는 지적.
    copiedButton: "복사했어요 ✓",
    // 복사 후 대기 화면 — AI가 초안을 올리는 순간 자동으로 확인 화면이 열린다.
    waitingTitle: "AI가 올려주기를 기다리는 중",
    waitingBody: "복사한 프롬프트를 AI 대화창에 붙여넣으세요. 작품이 도착하면 이 창이 저절로 닫히고 확인 화면이 열려요.",
    // 채팅 AI는 스스로 못 올린다 — "기다리는 중" 대신 답을 가져올 곳을 바로 알려준다.
    chatNextTitle: "AI 답을 받으면 여기로 가져와요",
    chatNextBody: "채팅 AI는 스스로 올리지 못해요. AI가 준 답을 통째로 복사한 뒤 아래 버튼을 누르세요. 새 탭에서 열리고, 이 창은 그대로 기다리다가 작품이 도착하면 확인 화면을 열어요.",
    // 터미널 AI가 예상과 달리 답만 주고 끝난 경우의 출구(2026-09-18).
    pasteJsonLead: "AI가 답만 주고 끝났나요?",
    pasteJsonCta: "AI 답 붙여넣기",
    pasteJsonHint: "그 AI가 스스로 못 올리는 경우예요. AI 답을 통째로 복사해 두고 이 버튼을 누르면, 새 탭에서 붙여넣기만 하면 돼요. 작품 파일도 거기서 올릴 수 있어요.",
    ...
    previewToggle: "프롬프트 미리보기 (AI에게 줄 부탁 글)",
    ...
    mcpRemoteCopy: "주소 복사",
    mcpRemoteCopied: "복사했어요 — 클로드 설정에 붙여넣으세요.",
