...
export const ko = {
  ...
  connect: {
    ...
    promptTitle: "당신의 AI에 붙여넣으세요",
    promptBody: "복사 버튼을 누르면 연결 토큰(AI가 당신 계정에 올릴 수 있게 하는 열쇠)이 새로 발급돼 프롬프트 안에 들어가요. 발급 과정은 따로 없어요 — 복사해서 붙여넣으면 끝.",
    copyPrompt: "프롬프트 복사",
    copying: "토큰 발급·복사 중…",
    copiedNote: "복사됐어요 ✓ 프롬프트 안에 새 토큰이 들어 있어요. 토큰은 다시 볼 수 없고, 다음에 새로 복사하면 이번 토큰은 자동으로 폐기돼요.",
