...
export const ko = {
  ...
  projects: {
    ...
    publishedNoticePaused: "공개됐어요 · 촬영 요청이 접수됐어요 — 순서대로 촬영되고, 끝나면 메일로 알려드려요",
    publishedNoticeNoDemo: "공개됐어요 · 직접 준 영상이 그대로 쓰여요",
    progressTitle: "촬영 진행",
    progressRequestedAt: (when: string) => `요청 ${when}`,
    progressPhases: ["촬영 대기", "앱 준비", "촬영", "편집"],
    progressPausedBody: "지금은 촬영이 순서대로 몰아서 진행돼요. 차례가 오면 자동으로 시작되고, 끝나면 메일로 알려드려요.",
  ...
  connect: {
    ...
    pickTerminal: "클로드코드 · 커서",
    pickTerminalSub: "터미널·코드 편집기에서 쓰는 AI",
    pickClaude: "클로드",
    pickClaudeSub: "claude.ai 웹 · 데스크탑 앱",
    pickChat: "ChatGPT · 제미나이",
    pickChatSub: "그 밖의 채팅 AI",
    stepsTerminal: "프롬프트 복사 → 그 AI에게 붙여넣기 → 초안이 여기 도착 → 확인 후 공개",
    stepsChat: "프롬프트 복사 → 작품을 만든 대화에 붙여넣기 → AI 답을 가져와 붙여넣기 → 확인 후 공개",
    stepsClaude: "주소 복사 → 클로드 설정에 한 번 붙여넣기 → 작품을 만든 대화에서 \"Nookframe에 올려줘\"",
    copyPrompt: "프롬프트 복사",
    copying: "준비 중…",
    ...
    mcpRemoteTitle: "클로드 설정에 이 주소를 한 번 붙여넣기",
    mcpRemoteHint: "클로드에서 설정 → 커넥터 → [커스텀 커넥터 추가]에 이 주소를 넣고, 뜨는 안내대로 [허용]을 누르면 끝이에요. 설치할 것도, 옮길 열쇠도 없어요.",
    mcpRemoteAuthTip: "연결 방식을 고르라고 하면 추천으로 표시된 쪽을 그대로 두세요.",
    mcpRemoteNext: "그다음부터는 작품을 만든 대화에서 \"이거 Nookframe에 올려줘\"라고만 하면 돼요. 초안이 오면 이 창이 저절로 확인 화면을 열어요.",
