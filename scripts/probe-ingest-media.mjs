...
try {
  ...
  const r2 = await runPublish({
    payload: { title: "__probe_2step_media__", targetDevice: "desktop", description: "프로브가 만든 임시 행\n곧 지워집니다", deployUrl: "https://example.com" },
